  ...
  <div class="menu">
    ...
    <div class="menu-content">
      ...
      <router-link to="/discover" class="menu-item">
        <svg class="m-icon menu-icon">
          <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('discover') !== -1? '#findActive' : '#find'"></use>
        </svg>
        <span class="menu-name">发现</span>
      </router-link>
